	...
	.export		ppudrv_set_stream4

	.include	"ndk.inc"

.segment	"PPUDRV_CODE"
;===============================================================
;	void	ppudrv_set_stream4(char* r0, char* AX, char Y)
;---------------------------------------------------------------
...
;===============================================================
.proc	ppudrv_set_stream4

	pha
@L1:	lda	__PPUDRV_T3_Cnt
	bne	@L1			;空になるまで待つ
	pla

	STAX	__PPUDRV_D3_Pt		;書き込み先のPPUアドレスを保存

	LDAX	__r0
	STAX	__PPUDRV_S3_Pt

	sty	__PPUDRV_T3_Cnt		;フラグセット
